...
// Esto último significa que el año 1900 no es bisiesto, pero el año 2000 sí lo es. Hacer un programa para
...
int main() {
    ...
    if((ano % 4 == 0 && ano % 100 != 0) || ano % 400 == 0){
        cout << ano << " es bisiesto" << endl;
    } else {
        cout << ano << " no es bisiesto" << endl;
    }
